...
public class DGrid extends DComponent {
	 ...
	 * 
	 * @param rectangle
	 *            the rectangle around the grid
	 * @param hor_dist
	 *            the horizontal distance between the lines in D-coordinates,
	 *            not in pixel coordinates!
	 * @param ver_dist
	 *            vertical distance between the lines in D-coordinates, not in
	 *            pixel coordinates!
	 */
	 ...
	 *            not in pixel coordinates!
	 * @param ver_dist
	 *            the vertical distance between the lines in D-coordinates, not
	 *            in pixel coordinates!
	 * @param color
	 *            the color of the grid ( can also be set by setColor(
	 *            java.awt.Color ) )
	 */
	public DGrid(DRectangle rectangle, double hor_dist, double ver_dist,
			Color color) {
	 ...
	 * 
	 * @param m
	 *            the <code>DMeasures</code> object to paint the grid
	 */
	public void paint(DMeasures m) {
		...
		if (minX * hor_dist <= rectangle.x)
			minX++;
		minX *= hor_dist;
		minY = (int) (rectangle.y / ver_dist);
		if (minY * ver_dist <= rectangle.y)
			minY++;
		minY *= ver_dist;
