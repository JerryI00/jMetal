...
package org.uma.jmetal.problem.multiobjective.grn.util.ra.sort;
...
public class XYDoubleArray implements Cloneable {
	...
	/*
	 * public final void sortX(){ QuickInsertSort quickInsertSort = new
	 * QuickInsertSort(); quickInsertSort.sortX(this); }
	 * 
	 * public final void sortY(){ QuickInsertSort quickInsertSort = new
	 * QuickInsertSort(); quickInsertSort.sortY(this); }
	 */
	...
	//
	/*
	 * public String toString(){ return toString(TABLE_OUTPUT); }
	 * 
	 * private String toString(int output){ if(x==null || y==null)return null;
	 * BasicDataSet data=new BasicDataSet(x, y, AbstractDataSet.CONTINUOUS_DATA,
	 * "x", "y"); String s=JChart2DUtils.writeDataSetToString(data, output);
	 * return s; }
	 */
