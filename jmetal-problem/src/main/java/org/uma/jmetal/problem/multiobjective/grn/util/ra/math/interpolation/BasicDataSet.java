...
import org.uma.jmetal.problem.multiobjective.grn.util.ra.sort.XYDoubleArray;
...
public class BasicDataSet extends AbstractDataSet {
	...
	public BasicDataSet(double[] xDoubleData, double[] yDoubleData, int dataType) {
		this(xDoubleData, yDoubleData, null, null);
	}

	public BasicDataSet(double[] xDoubleData, double[] yDoubleData,
