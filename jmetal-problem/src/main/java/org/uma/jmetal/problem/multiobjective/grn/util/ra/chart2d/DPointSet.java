...
import org.uma.jmetal.problem.multiobjective.grn.util.ra.tool.IntegerArrayList;
...
public class DPointSet extends DComponent {
	...
	public DPointSet(int initial_capacity, int length_multiplier) {
		this(new DArray(initial_capacity, length_multiplier), new DArray(
				initial_capacity, length_multiplier));
	}
	...
	/**
	 * method removes all jump positions if the DPointSet is connected, all
	 * points will be painted connected to their following point
	 */
	...
	/**
	 * method sets the stroke of the line if the points were not connected, they
	...
	/**
	 * method returns the index to the nearest <code>DPoint</code> in this
	 * <code>DPointSet</code>.
	 * 
	 * @return the index to the nearest <code>DPoint</code>. -1 if no nearest
	...
	/**
	 * method returns the nearest <code>DPoint</code> in this
	 * <code>DPointSet</code>.
	 * 
   ...
   */
	...
	protected void restore() {
		...
		double min_x = x.getMinImageValue(), max_x = x.getMaxImageValue(), min_y = y
				.getMinImageValue(), max_y = y.getMaxImageValue();
