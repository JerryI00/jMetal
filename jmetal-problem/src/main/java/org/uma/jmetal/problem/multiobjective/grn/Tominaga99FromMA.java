...
public class Tominaga99FromMA extends AbstractDoubleProblem {
  ...
  private double tominagaThreshold = 0.1; // default in Tominaga's paper 99. To be performed every 5 generations
  ...
  public Tominaga99FromMA(Integer numberOfVariables, int numberOfObjectives, String matrixFileName) {
    ...
    System.out.println("VARs:" + numberOfVariables + " MA File " + matrixFileName);
  ...
  public void evaluate(DoubleSolution solution) {
    this.tominagaSkeletizing(0.01, solution); //0.01
