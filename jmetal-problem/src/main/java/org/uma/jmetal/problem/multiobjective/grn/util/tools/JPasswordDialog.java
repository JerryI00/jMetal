...
public class JPasswordDialog extends JDialog {
	...
	/**
	 * A simple example to show how this might be used. If there are arguments
	 * passed to this program, the first is treated as the default name, the
	 * second as the default password
	 * 
	 * @param args
...
/*
 * public class JPasswordDialog extends JDialog { JTextField loginfield;
 * JPasswordField passfield;
 * 
 * public JPasswordDialog() throws HeadlessException { passfield = new
 * JPasswordField(10); loginfield = new JTextField(10); }
 * 
