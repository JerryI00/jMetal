...
import org.uma.jmetal.problem.multiobjective.grn.util.ra.math.Jama.Matrix;
import org.uma.jmetal.problem.multiobjective.grn.util.ra.math.interpolation.BasicDataSet;
import org.uma.jmetal.problem.multiobjective.grn.util.ra.math.interpolation.InterpolationException;
import org.uma.jmetal.problem.multiobjective.grn.util.ra.math.interpolation.SplineInterpolation;
...
public class Mathematics {
	...
	public static Matrix getRotationMatrix(Matrix vec) {
		...
		for (int i = 1; i < vec.getRowDimension(); i++) {
			w = Math.atan2(z.get(i, 0), z.get(0, 0));// calc angle between the
														// projection of x and
														// x0 in x0-xi-plane
