...
public abstract class DFunction extends DComponent {
	...
	public abstract double getSourceOf(double image)
			throws IllegalArgumentException;

	public abstract double getImageOf(double source)
			throws IllegalArgumentException;
	...
	public void paint(DMeasures m) {
		...
		DRectangle rect = m.getDRectangle(), src_rect = m.getSourceOf(rect);
		Point sw = m.getPoint(rect.x, rect.y), ne = m.getPoint(rect.x
