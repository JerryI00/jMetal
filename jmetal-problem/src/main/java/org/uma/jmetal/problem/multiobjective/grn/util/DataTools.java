...
import org.uma.jmetal.problem.multiobjective.grn.util.ra.math.RNG;
...
//		//read data
//		 mad= new MicroarrayData("Tu17.txt");
//		mad.initMadFromFile();
//		
//		 processor=new DataTools();
//		
//		mad=processor.normaliseMadNoTrans(mad);
//		
//		
//		mad.writeToFile("Tu17Norm.txt");
//		
//		mad= new MicroarrayData("Tu17.txt");
//		mad.initMadFromFile();
//		
...
//				}
//			}
//		mad=processor.scaleMad(mad, 1/factor);
//		mad.writeToFile("Tu17Scaled.txt");
//		
//		
//		//read data
//		 mad= new MicroarrayData("Hasse9.txt");
//		mad.initMadFromFile();
//		
//		 processor=new DataTools();
//		
...
//		
//		
//		mad.writeToFile("Hasse9Norm.txt");
//		
//		mad= new MicroarrayData("Hasse9.txt");
//		mad.initMadFromFile();
//		
...
//			}
//		mad=processor.scaleMad(mad,1/ factor);
//		mad.writeToFile("Hasse9Scaled.txt");
//		
//		//read data
//		 mad= new MicroarrayData("Hasse17.txt");
//		mad.initMadFromFile();
//		
//		 processor=new DataTools();
//		
...
//		
//		
//		mad.writeToFile("Hasse17Norm.txt");
//		
//		mad= new MicroarrayData("Hasse17.txt");
//		mad.initMadFromFile();
//		
...
//			}
//		mad=processor.scaleMad(mad, 1/factor);
//		mad.writeToFile("Hasse17Scaled.txt");
//		
//		//read data
//		 mad= new MicroarrayData("Hasse9Mutant.txt");
//		mad.initMadFromFile();
//		
//		 processor=new DataTools();
//		
...
//		
//		
//		mad.writeToFile("Hasse9MutantNorm.txt");
//		
//		mad= new MicroarrayData("Hasse9Mutant.txt");
//		mad.initMadFromFile();
//		
...
//			}
//		mad=processor.scaleMad(mad, 1/factor);
//		mad.writeToFile("Hasse9MutantScaled.txt");
//		
//		//read data
//		 mad= new MicroarrayData("Hasse17Mutant.txt");
//		mad.initMadFromFile();
//		
//		 processor=new DataTools();
//		
...
//		
//		
//		mad.writeToFile("Hasse17MutantNorm.txt");
//		
//		mad= new MicroarrayData("Hasse17Mutant.txt");
//		mad.initMadFromFile();
//		
...
//			}
//		mad=processor.scaleMad(mad, 1/factor);
//		mad.writeToFile("Hasse17MutantScaled.txt");
//		
//		mad= new MicroarrayData("S107.txt");
//		mad.initMadFromFile();
//		
...
//			}
//		}
//		mad=processor.translateMad(mad,-min);
//		
//		 max=0;
//		for(int i=0;i<mad.getTimeSeriesCount();i++)
//		{
...
//			}
//		}
//		processor.scaleMad(mad, 1/max).writeToFile("S107Scaled.txt");
//		
//		
//		//filter
//		DataTools processor= new DataTools();
//		mad=processor.filterGenes(mad, 100);
//		mad.writeToFile("1_drosophila_growth_format_filteredgenes.txt");
//		//normalise
//		processor.normaliseMad(mad);
//		//write data
//		mad.writeToFile("1_drosophila_growth_format_filteredgenes_normalised.txt");
		
//		MicroarrayData mad= new MicroarrayData("Perceptron5GeneratedData.txt");
//		mad.initMadFromFile();
		
//		DataTools processor=new DataTools();
//		processor.addNoise(mad, 0.05).writeToFile("SS5GeneratedData5Noise.txt");
		
	//	processor.addNoise(mad, 0.1).writeToFile("ANN5GeneratedData10Noise.txt");
//		
//		processor.addNoise(mad, 0.1).writeToFile("ANN5GeneratedData10Noise.txt");
//		
//		processor.addNoise(mad, 0.2).writeToFile("ANN5GeneratedData20Noise.txt");
