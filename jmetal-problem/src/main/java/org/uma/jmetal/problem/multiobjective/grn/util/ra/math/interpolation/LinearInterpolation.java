...
public class LinearInterpolation {
	...
	/**
	 * Find the p value for a given value of F. Requires the COLT high
	 * performance library: http://hoschek.home.cern.ch/hoschek/colt/
	 * 
	 * @param fValue
	 *            the value for the CDF
	 * @return The P value
	 */
