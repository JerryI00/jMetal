...
public class EVAERROR {
   ...
   */
	...
	/**
	 * Send a message only once to System.err. Once means that the msg is stored
	 * for the lifetime of the VM or until clearMsgCache() is called.
	 * 
	 * @param msg
	 */
	static public void errorMsgOnce(String msg) {
		if (errMap == null)
			errMap = new HashMap<String, Boolean>();
	...
	/**
	 * Clear the error message cache, so that any error messages are displayed
	 * at least once.
	 */
