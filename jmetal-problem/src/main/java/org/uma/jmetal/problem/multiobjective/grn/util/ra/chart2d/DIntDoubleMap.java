 ...
 * only be shown by the DArea, when the DPointSet.repaint method is called. This
 * should be done in the implementation of the #setImage and #addImage method.
 * To get the functionality of the DArea, the methods #getMaxImageValue and
 * #getMinImageValue are necessary.
 */
public interface DIntDoubleMap {

	/**
	 * implementation should change the map in that way, that from now the image
	 * of index is v
	 * 
	 * @param source
	 *            the preimage of the image
	 * @param image
	 *            the new image of the source value
	...
	/**
	 * checks the minimal and the maximal image values and returns
	 * <code>true</code> when at least one of them has changed
	 * 
