...
public class StatisticUtils {
	 ...
	 * @param counts
	 *            array of counts
	 * @return - a log2 a - b log2 b - c log2 c when given array [a b c]
	 */
	 ...
	 * 
	 * Correlation ("Statistik", 7 Aufl., Hartung, 1989, Kapitel 9 und 10,
	 * S.546-608): a=yMess[i]; b=yWahr[i]; aa=a*a; bb=b*b; ab=a*b;
	...
	// The following methods got mysteriously lost maybe during cvs-svn
	// refactoring.
	// For the time being I add method thunks which give a warning when called.
	// (mkron)
